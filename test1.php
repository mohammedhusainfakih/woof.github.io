    ...
    <div class="section">
      <div class="container">
        <div class="row" style="background-color:#4286f4; border: 05px solid black;">
          <div><h1 style="text-align:center;">NON-SPORTING DOG'S</h1></div>
          ...
          <div class="col-md-3">
                     <?php
                          ...
                          echo "<a href = 'test1.1php'> <img src = '$path' class='center-block image-responsivew' /> </a><a href = 'test1.1.php'><h2 style='text-align:center'>French Bulldog</h2></a> <br><br>";
                          }
                        }
                    ?>   
          </div>
        ...
        <div class="col-md-3">
                          ...
                          $xml = new SimpleXMLElement($thexmlfile);
                            ...
                            for ($x = 0; $x <= 0; $x++) {
                              ...
                              $name = (string)$xml->album[$x]->img[$y]->attributes()->thumb;           
                              $path = $folder."".$catgr."".$name;
                          echo "<a href = 'test1.2.php'> <img src = '$path' class='center-block image-responsive' /> </a><a href = 'test1.2.php'><h2 style='text-align:center'>Bulldog</h2></a> <br><br>";
                          }
                        }
                    ?> 
            </div>
                      ...
                      <?php
                          ...
                          $xml = new SimpleXMLElement($thexmlfile);
                            ...
                            for ($x = 0; $x <= 0; $x++) {
                              ...
                              $name = (string)$xml->album[$x]->img[$y]->attributes()->thumb;           
                              $path = $folder."".$catgr."".$name;
                          echo "<a href = 'test1.3.php'> <img src = '$path' class='center-block image-responsive' /> </a><a href = 'test1.3.php'><h2 style='text-align:center'>Boston Terrier</h2></a> <br><br>";
                          }
                        }
                    ?> 
    </div>
                    ...
                    <?php
                          ...
                          $xml = new SimpleXMLElement($thexmlfile);
                            ...
                            for ($x = 0; $x <= 0; $x++) {
                              ...
                              $name = (string)$xml->album[$x]->img[$y]->attributes()->thumb;           
                              $path = $folder."".$catgr."".$name;
                          echo "<a href = 'test1.4.php'> <img src = '$path' class='center-block image-responsive' /> </a><a href = 'test1.4.php'><h2 style='text-align:center'>Keeshond</h2></a> <br><br>";
                          }
                        }
                    ?> 
          </div>
