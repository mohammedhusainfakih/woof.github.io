  ...
  <body background="img/dogwall.png">
    <div class="section">
      <div class="container">
        ...
        <div class="section">
      <div class="container">
        <div class="row" style="background-color:#4286f4; border: 05px solid black;padding: 20px;">
          <div style="text-align:center;" class="col-md-12">
                     <img class="center-block image-responsive" src="img/cat2/thumb2.jpg">   
          </div>
          <div >
            <h1><a href="#">German Wirehead Pointer.</a></h1>
            <h3>Click on any of the following to know more.</h3>
