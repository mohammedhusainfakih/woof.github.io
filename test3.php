  ...
  <body background="img/dogwall.png">
    <div class="section">
      ...
      <div class="container">
        ...
        <div><h1 style="text-align: center;">SPORTING DOG'S</h1></div>
          ...
          <div class="col-md-6">
                     <?php
                          ...
                          echo "<a href = 'test3.1.php'> <img src = '$path' class='center-block image-responsive' /> </a><a href = 'test3.1.php'><h2 
                           style='text-align:center'>American Water Spaniel</h2></a> <br><br>";
                          }
                        }
                    ?>   
          </div>
                     ...
                     <?php
                          ...
                          $xml = new SimpleXMLElement($thexmlfile);
                            ...
                            for ($x = 2; $x <= 2; $x++) {
                              ...
                              $name = (string)$xml->album[$x]->img[$y]->attributes()->thumb;           
                              $path = $folder."".$catgr."".$name;
                          echo "<a href = 'test3.2.php'> <img src = '$path' class='center-block image-responsive' /> </a><a href = 'test3.2.php'> <h2 style='text-align:center'>German Wirehead Pointer</h2></a><br><br>";
                          }
                        }
                    ?>   
          </div>
